...
class ConnectedQuery extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    let validatedTreeChanged =
      oldValidatedTree !== this.validatedTree &&
...
const QueryContainer = connect(state => {
  return {
    tree: state.tree
  };
})(ConnectedQuery);
...
export default class Query extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    let getQueryStringForProps = props =>
      props.value != null ? queryString(props.value, props) : "";
